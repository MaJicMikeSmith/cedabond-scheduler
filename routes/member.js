...
router.post('/bookings', async (req, res) => {
  ...
  const dayIds = getMemberDayIds(memberId);
  if (!dayIds.includes(slot.day_id)) return res.status(403).json({ error: 'None of your registered attendees are present on that day' });
